...
contract('TrustfeedCrowdsale', function ([owner, wallet, investor]) {
  ...
  beforeEach(async function () {
    ...
    this.token = await TrustfeedToken.new({ from: owner });
    this.crowdsale = await TrustfeedCrowdsale.new(
  ...
  describe('when goal > cap', function () {
    ...
    it('creation reverts', async function () {
      await assertRevert(TrustfeedCrowdsale.new(
